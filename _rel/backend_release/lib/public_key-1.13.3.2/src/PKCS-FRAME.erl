%% Generated by the Erlang ASN.1 BER compiler. Version: 5.0.21.1
...
-asn1_info([{vsn,'5.0.21.1'},
            {module,'PKCS-FRAME'},
            {options,[{i,"/build/erlang-0pdjGY/erlang-25.3.2.8+dfsg/lib/public_key/asn1/../src"},
 warnings,ber,errors,
 {cwd,"/build/erlang-0pdjGY/erlang-25.3.2.8+dfsg/lib/public_key/asn1"},
 {outdir,"/build/erlang-0pdjGY/erlang-25.3.2.8+dfsg/lib/public_key/asn1/../src"},
 der,noobj,asn1config,
 {i,"."},
 {i,"/build/erlang-0pdjGY/erlang-25.3.2.8+dfsg/lib/public_key/asn1"}]}]).
